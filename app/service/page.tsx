  ...
  if (!mounted) {
    return (
      <div className="flex flex-col min-h-screen">
        <div className="h-[300px] bg-darkgray"></div>
        <div className="py-12">
          <div className="container">
            <div className="h-8 w-3/4 bg-charcoal rounded mb-6"></div>
            <div className="h-4 w-full bg-charcoal rounded"></div>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <section className="relative h-[400px] overflow-hidden">
        ...
        <div className="container relative z-20 flex h-full flex-col items-center justify-center text-white text-center">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6">Service Center</h1>
          <p className="mt-4 max-w-2xl text-xl text-gray-200 mb-8">
      ...
      <section className="py-16 bg-background">
        <div className="container">
          <div className="grid gap-12 md:grid-cols-2">
            <div>
              <h2 className="text-3xl font-bold tracking-tight mb-6 text-gold">Expert Service & Maintenance</h2>
              <p className="text-muted-foreground mb-6">
                Auto Vista is committed to ensuring you have a safe and reliable vehicle for years to come. By providing
                a fully equipped service and repair shop, you can rest easy knowing that the maintenance or repairs of
                your used vehicle can be performed with ease and convenience, bringing the same great experience from
                our showroom right into our service department.
              </p>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl mb-2">Factory-Trained Technicians</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl mb-2">State-of-the-Art Equipment</h3>
                    <p className="text-muted-foreground">
      ...
      <section className="bg-charcoal py-16">
        <div className="container">
          <h2 className="text-3xl font-bold tracking-tight text-center mb-12 text-gold">Our Services</h2>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="bg-darkgray border border-border p-6 rounded-md flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gold">Preventative Maintenance</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-darkgray border border-border p-6 rounded-md flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gold">Auto Diagnostics</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-darkgray border border-border p-6 rounded-md flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gold">Auto Repairs</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-darkgray border border-border p-6 rounded-md flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold mb-3 text-gold">Wheels and Tires Service</h3>
              <p className="text-muted-foreground">
      ...
      <section id="schedule" className="bg-charcoal py-16">
        <div className="container max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold tracking-tight text-center mb-8 text-gold">Schedule Your Service</h2>
